...
#Extract data that is either Mean or Standard Deviation of original data
...
#Export summary/tidy dataset to text file
write.table(subset_summary, "tidyData.txt", sep = " ")